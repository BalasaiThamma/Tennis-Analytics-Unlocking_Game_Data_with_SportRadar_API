...
# Database Connection
my_db = myconn.connect(host="localhost", username="root", password="Balasai2001@", database="guvi_projects")
...
def fetch_data(endpoint):
    url = "https://api.sportradar.com/tennis/trial/v3/en/competitions.json?api_key=FDQaonBWCYVbUX2RWml6h9SXTzoxGlFRk4OQYyAw"
